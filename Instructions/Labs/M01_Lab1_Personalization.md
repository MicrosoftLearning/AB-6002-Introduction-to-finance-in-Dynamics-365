...
3.  Select **Insert columns...**. Add the column **Invoicing and delivery on hold (Confirmation, delivery and invoicing on hold)**. You can filter the **Field** column in the list to help locate this column.
