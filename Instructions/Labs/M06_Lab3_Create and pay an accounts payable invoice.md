...
lab:
  ...
  module: 'Module 6: Describe accounts payables, accounts receivables, and credit
    and collections'
  description: In this lab, you’ll create and post an accounts payable invoice journal.
    Then you’ll create a vendor payment for the invoice in Dynamics 365 Finance.
  duration: 20 minutes
  level: 100
  islab: true
  primarytopics:
